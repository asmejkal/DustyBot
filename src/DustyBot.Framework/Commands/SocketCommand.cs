...
namespace DustyBot.Framework.Commands
{
    public class SocketCommand : ICommand
    {
        ...
        public Task<ICollection<IUserMessage>> ReplySuccess(ICommunicator communicator, string message, Embed embed = null) => communicator.CommandReplySuccess(Message.Channel, message, embed);
        public Task<ICollection<IUserMessage>> ReplyError(ICommunicator communicator, string message) => communicator.CommandReplyError(Message.Channel, message);
