...
namespace DustyBot.Modules
{
    ...
    class ScheduleModule : Module
    {
        ...
        public async Task Schedule(ICommand command)
        {
            ...
            string channelReference = string.Empty;
            ...
            var embed = new EmbedBuilder()
                ...
                .WithFooter($"Events until {currentTime.AddDays(14).ToString(@"MM\/dd")} • Full schedule in #{channelReference}")
        ...
        [Usage("{p}schedule add MessageId\n\n__Example:__ {p}schedule add 464071206920781835\n\nThe specified message will be parsed to be used by the `schedule` command. Expected format of the message is " +
